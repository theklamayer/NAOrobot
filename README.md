...
The NAO robot reacts to a detected person, turns toward them, walks forward, greets them using speech output, and takes a photo with its camera.

`human_greeter.py` contains the main interaction flow:
detect person → turn → walk → greet → take picture
